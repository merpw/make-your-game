 ...
 */
export const getFrame = (col, row, width = ATLAS_CELL_ART_SIZE, height = ATLAS_CELL_ART_SIZE, flipX = false) => {
    return {
        /**
        ...
        */
        viewBox: flipX
            ? `${-(col + 1) * ATLAS_CELL_SIZE + ATLAS_CELL_SIZE - width} ${row * ATLAS_CELL_SIZE} ${width} ${height}`
