...
export default class Cell extends Animated {
    ...
    set type(value) {
        ...
        if (value === "empty") {
            ...
            if (this.secret === "portal") {
                ...
                (_a = this.animationManager) === null || _a === void 0 ? void 0 : _a.play("off");
                return;
            }
            if (this.secret === "potion") {
                this.setAsset("potion");
                (_b = this.animationManager) === null || _b === void 0 ? void 0 : _b.play("stand");
                return;
            }
            return;
        }
        ...
        if (value === "spawn") {
            this.setAsset("cloud");
            (_c = this.animationManager) === null || _c === void 0 ? void 0 : _c.play("blue");
            this.addTimer(() => {
                this.type = "empty";
            }, PLAYER_CLOUD_TIME);
            return;
        ...
        if (value === "cloud" || value === "portalActivated") {
            ...
            if (this.secret) {
                ...
                (_d = document.getElementById("landscape")) === null || _d === void 0 ? void 0 : _d.appendChild(bg);
            }
            this.setAsset("cloud");
            (_e = this.animationManager) === null || _e === void 0 ? void 0 : _e.play(value === "cloud" ? "pink" : "blue");
            this.addTimer(() => {
        ...
        if (value === "fungus") {
            ...
            (_f = this.animationManager) === null || _f === void 0 ? void 0 : _f.play("stand");
            return;
        }
        if (value === "portal") {
            this.setAsset("portal");
            (_g = this.animationManager) === null || _g === void 0 ? void 0 : _g.play("on");
            return;
        }
    }
    constructor(typeCode, col, row) {
        ...
        (_a = document.getElementById("landscape")) === null || _a === void 0 ? void 0 : _a.appendChild(grass);
