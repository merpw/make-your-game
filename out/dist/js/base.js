...
export class Animated {
  ...
  setAsset(assetName) {
    ...
    switch (assetName) {
      case "hero":
        return (_b = document.getElementById("players")) === null ||
          _b === void 0
          ? void 0
          : _b.appendChild(this.element)
      case "sheep":
        return (_c = document.getElementById("sheep")) === null || _c === void 0
          ? void 0
          : _c.appendChild(this.element)
      case "fungus":
        return (_d = document.getElementById("fungi")) === null || _d === void 0
          ? void 0
          : _d.appendChild(this.element)
      case "cloud":
        return (_e = document.getElementById("clouds")) === null ||
          _e === void 0
          ? void 0
          : _e.appendChild(this.element)
      default:
        return (_f = document.getElementById("landscape")) === null ||
          _f === void 0
          ? void 0
          : _f.appendChild(this.element)
    }
  }
